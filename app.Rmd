...
Moreover, each independent variable is found not significant. The religious independent variable had the lowest with `0.0993` > `0.05` = alpha level. This signifies that 
