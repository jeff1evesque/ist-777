...
Both approaches indicate a fairly strong relationship between the dependent variable (conditional), with its associated independent variables.
...
Furthemore, the bayes r-squared `0.07022636` is larger than `0.07505` from the conventional analysis:
...
However, both approaches indicate that the model does not predict well between the dependent variable (medical), with its associated independent variables.
